...
def main():
    ...
    cluster=pd.read_csv("outputs/segmentacion/model_2_completo_cluster_5_2025-09-20_10-14-27.csv",index_col=0)
    ...
    # submuestreo
    X_train_sample_imp=X_train_imp.loc[cluster.index]
    y_train_sample = y_train.loc[cluster.index]

                # Guardo df
    try:
        X_train_sample_imp.to_csv(path_output_data + "X_train_sample_imp_a_usar.csv") 
        y_train_sample.to_csv(path_output_data + "y_train_sample_a_usar.csv") 
